namespace GuATraining.Sales.Customer.BingMapsControl;
...
controladdin "BSB BingMapsControl"
{
    ...
    Scripts =
        ...
        'Sales/Customer/BingMapsControl/Script.js';
    StartupScript = 'Sales/Customer/BingMapsControl/StartupScript.js';
